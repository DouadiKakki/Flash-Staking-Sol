	...
	return (
		<div id="partners" className='w-full px-[20px] mt-[60px] lg:mt-[200px]'>
			<div className='relative max-w-full w-[1440px] h-[36px] lg:h-[128px] mx-auto py-[2px] bg-gradient-to-r from-[#141414] via-[#2b2b2b] via-50% to-[#141414]'>
				<div className='relative w-full h-full bg-[#191919] flex items-center'>
					<Swiper
						className="w-full h-[16px] lg:h-[60px]"
					...
					>
						{partners.map((item, index) =>
							<SwiperSlide key={index} className='max-w-[60px] lg:max-w-[220px]'>
								<div className='w-[60px] lg:w-[220px] h-[15px] lg:h-[60px] flex justify-center items-center'>
									<img src={item.img} alt={item.name} className='cursor-pointer hover:scale-125 transition-all duration-500' />
								</div>
							</SwiperSlide>
						)}
					</Swiper>
					<div className='absolute h-full w-[80px] lg:w-[150px] z-10 top-0 left-0 bg-gradient-to-r from-[#111111] from-10% to-transparent'></div>
					<div className='absolute h-full w-[80px] lg:w-[150px] z-10 top-0 right-0 bg-gradient-to-l from-[#111111] from-10% to-transparent'></div>
				</div>
			</div>
		</div>
	);
