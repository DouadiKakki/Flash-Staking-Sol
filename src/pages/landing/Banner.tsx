...
const Banner = () => {
	...
	return (
		<div id="home" className='w-full pt-[130px] lg:pt-[260px] flex flex-col items-center px-[20px]'>
			...
			>
				...
				<div className='mt-[47px] lg:mt-[20px] w-full flex flex-col justify-center lg:flex-row gap-5'>
					<IconButton
						text='Start Staking'
